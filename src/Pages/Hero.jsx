        ...
        <div className='h-full lg:h-screen w-full lg:p-16 p-10' id='home'>
            ...
            <div className='flex lg:flex-row md:flex-col flex-col-reverse justify-between items-center lg:gap-20 gap-8 h-full w-full rounded-xl shadow-lg p-5 bg-white'>
                    ...
                    <div className='h-16 w-full  flex justify-center items-center gap-4'>
                        <a href="https://github.com/marikannan16" target='_blank'>
                            <svg id='social'
                                ...
                                className="lg:size-10 size-9 hover:border hover:border-white p-2  hover:rounded-lg text-yellow-400 hover:text-black hover:animate-pulse"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
                        ...
                        <a href="https://www.instagram.com/i_am_brucewayne_16?igsh=d3VuaHJldWt4YjVw" target='_blank'>
                            <svg id='social'
                                xmlns="http://www.w3.org/2000/svg"
                                className="lg:size-10 size-9 hover:border hover:border-white p-2  hover:rounded-lg text-yellow-400 hover:text-[#c13584] hover:animate-pulse"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
                        ...
                        <a href="https://www.linkedin.com/in/mari-kannan-b-66ab67227" target='_blank'>
                            <svg id='social'
                                xmlns="http://www.w3.org/2000/svg"
                                className="lg:size-10 size-9 hover:border hover:border-white p-2  hover:rounded-lg mb-1 text-yellow-400 hover:text-[#0077b5] hover:animate-pulse"
                                fill="currentColor"
                                viewBox="0 0 24 24"
                            >
                                <path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2 gap-5.lg:155z" />
                            </svg>
                        </a>
                ...
                {/* <div className='h-full w-4/5  flex justify-center items-center'>
                    <img src={mobile} className='w-full h-fit' alt="" id='mobile'/>
                    <p className='absolute -bottom-12 lg:top-72' id='mobiletext'>Your Vision</p>
                    <p className='absolute -bottom-[6rem] lg:top-80' id='mobiletext'>My Code</p>
                    <p className='absolute -bottom-[9rem] lg:top-[22rem]' id='mobiletext'>Let’s Innovate.</p>
                </div> */}
            </div>
        </div>
    )
